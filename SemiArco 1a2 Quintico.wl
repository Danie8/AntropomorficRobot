...
Centro = (NA + NC)/2;
Radio = Norm[NA - NC]/
   6;  (*Reducir el radio a un tercio de la distancia original*)
...
puntosSemicirc = 
  Table[{Centro[[1]] + Radio*Cos[theta]*vectorAB[[1]]/Norm[vectorAB] +
      Radio*Sin[theta]*vectorAD[[1]]/Norm[vectorAD], 
    Centro[[2]] + Radio*Cos[theta]*vectorAB[[2]]/Norm[vectorAB] + 
     Radio*Sin[theta]*vectorAD[[2]]/Norm[vectorAD], 
    Centro[[3]] + Radio*Cos[theta]*vectorAB[[3]]/Norm[vectorAB] + 
     Radio*Sin[theta]*vectorAD[[3]]/Norm[vectorAD]}, {theta, 0, Pi, 
    Pi/50}];
...
Plot[theta, {t, 0, tf}, AxesLabel -> {"t", "Perfil Quíntico"}, 
